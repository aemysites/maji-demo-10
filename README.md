...
## Environments
- Preview: https://main--maji-demo-10--aemysites.aem.page/
- Live: https://main--maji-demo-10--aemysites.aem.live/
- Block Library: https://main--maji-demo-10--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `maji-demo-10` directory in your favorite IDE and start coding :)
